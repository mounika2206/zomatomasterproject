...
<div className="w-full h-60  md:hidden">
     ...
     <div className="hidden w-full h-80 md:flex gap-1">
         ...
         <img
         src={props.images[1]}
         className="w-full h-full object-cover transition duration-700 transform hover:scale-110 rounded-lg"/>
        
         </div>
         <div className="w-1/6  h-full flex flex-col gap-3 overflow-hidden">
         <img
        src={props.images[2]}
         ...
         src={props.images[4]}
         className="w-full h-full object-cover rounded-lg  "/>
         <div className="absolute inset-0 bg-opacity-40  rounded-lg bg-black w-full h-full"></div>
        <h4 className="absolute inset-y-2/4 z-20 w-full h-full text-center text-white
        font-semibold">View Gallery</h4>
       </div>
       <div className="w-full h-full relative">
         <img
         src={props.images[5]}
         className="w-full h-full object-cover rounded-lg  "/>
         <div className="absolute inset-0 bg-opacity-90  rounded-lg bg-gray-400 w-full h-full"></div>
        <div className=" font-semibold  flex flex-col items-center absolute inset-y-1/4 z-20 w-full h-full text-center text-white">
