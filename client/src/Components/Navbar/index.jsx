...
import { FaRegKissWinkHeart, FaUserAlt } from "react-icons/fa";
import { HiLocationMarker } from "react-icons/hi";
import { IoMdArrowDropdown, IoMdArrowDropup } from "react-icons/io";
import { RiSearch2Line } from "react-icons/ri"

const MobileNav=()=>{
    return( <div class="flex w-full items-center justify-between md:hidden">
        <div className="w-28">
           <img
...
const MediumNavbar=()=>{
    return(
        ...
        <div className="w-full bg-white shadow-md px-4 py-3 flex  gap-3 border border-gray-200 rounded ">
            <div className="flex items-center gap-2 border-r-2 border-gray-300 pr-2">
                <span class="text-zomato-400">
                    <HiLocationMarker/>
                </span>
            ...
            <div className="flex items-center gap-2">
                ...
                className="w-full focus:outline-none"
                 placeholder="Search for restaurant,cuisine or
                a dish"/>
            </div>
        </div>
...
const LargeNavbar=()=>{
    return(
        <>
        <div className="hidden  gap-3 w-full items-center justify-between  md:flex">
        <div className="w-28">
           <img
          src="https://b.zmtcdn.com/web_assets/b40b97e677bc7b2ca77c58c61db266fe1603954218.png"
          alt="logo"
        ...
        <div className="w-full bg-white shadow-md px-4 py-3 flex  gap-3 border border-gray-200 rounded ">
            ...
            <div className="flex items-center gap-2">
                <RiSearch2Line/>
                <input type="search" placeholder="Search for restaurant,cuisine or
                a dish"/>
            </div>
        </div>
...

{
    return (
       <>
       <nav className="p-4 flex bg-white shadow-md w-full 
        items-center">
