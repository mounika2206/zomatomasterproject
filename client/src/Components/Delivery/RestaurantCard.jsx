...
{
    return<>
    <div className="bg-white p-4 mb-4 w-full rounded-2xl  transition duration-700 ease-in-out hover:shadow-md-lg md:w-1/2 lg:w-1/3">
        ...
        <div className="flex items-center justify-between">
            ...
            <span className="bg-green-800 text-white text-sm  bg-opacity-75 p-1  flex items-center rounded mr-3">
                {props.RestaurantreviewValue}<AiTwotoneStar/></span>
        </div>
        <div className="flex items-center justify-between text-gray-500">
            <p>{props.cuisine.join(",")}</p>
            <p> ₹{props. aveargeCost} for one</p>
        </div>
        </div>
